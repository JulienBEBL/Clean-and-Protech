...
Responsabilité : piloter le(s) buzzer(s) (fréquence, duty, séquences).
Le chip lgpio est fourni par gpio_handle (singleton partagé).

Note : V5 dispose de 2 buzzers passifs en parallèle sur la même broche GPIO
(config.BUZZER_GPIO = 21). Le comportement électrique et l'API sont identiques.
